...
TP_qda <- sum(df_test$default == "Yes" & df_test$pred_qda == "Yes") # CORRECTED: Use pred_qda
# True Negative count using QDA predictions
TN_qda <- sum(df_test$default == "No" & df_test$pred_qda == "No") # CORRECTED: Use pred_qda
# False Negative count using QDA predictions
FN_qda <- sum(df_test$default == "Yes" & df_test$pred_qda == "No") # CORRECTED: Use pred_qda
# False Positive count using QDA predictions
FP_qda <- sum(df_test$default == "No" & df_test$pred_qda == "Yes") # CORRECTED: Use pred_qda
